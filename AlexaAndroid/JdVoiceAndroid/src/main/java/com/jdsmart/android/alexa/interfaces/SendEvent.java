...
public abstract class SendEvent {
     ...
     * @param url the URL we're posting to, this is either the default {@link com.jdsmart.android.alexa.data.Directive} or {@link com.jdsmart.android.alexa.data.Event} URL
    ...
    private Call parseResponse() throws IOException, AvsException, RuntimeException {
        ...
        Log.i("LogUtils","sendEvent request = "+request.toString());
    ...
    /**
     * Get our JSON {@link com.jdsmart.android.alexa.data.Event} for this call
     * @return the JSON representation of the {@link com.jdsmart.android.alexa.data.Event}
     */
    @NotNull
