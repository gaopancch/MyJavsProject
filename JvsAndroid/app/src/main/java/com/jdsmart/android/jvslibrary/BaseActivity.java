...
import com.jdsmart.android.alexa.audioplayer.AlexaAudioPlayer;
...
import com.jdsmart.android.alexa.interfaces.audioplayer.AvsPlayContentItem;
import com.jdsmart.android.alexa.interfaces.audioplayer.AvsPlayRemoteItem;
import com.jdsmart.android.alexa.interfaces.errors.AvsResponseException;
import com.jdsmart.android.alexa.interfaces.playbackcontrol.AvsMediaNextCommandItem;
import com.jdsmart.android.alexa.interfaces.playbackcontrol.AvsMediaPauseCommandItem;
import com.jdsmart.android.alexa.interfaces.playbackcontrol.AvsMediaPlayCommandItem;
import com.jdsmart.android.alexa.interfaces.playbackcontrol.AvsMediaPreviousCommandItem;
import com.jdsmart.android.alexa.interfaces.playbackcontrol.AvsReplaceAllItem;
import com.jdsmart.android.alexa.interfaces.playbackcontrol.AvsReplaceEnqueuedItem;
import com.jdsmart.android.alexa.interfaces.playbackcontrol.AvsStopItem;
import com.jdsmart.android.alexa.interfaces.speaker.AvsAdjustVolumeItem;
import com.jdsmart.android.alexa.interfaces.speaker.AvsSetMuteItem;
import com.jdsmart.android.alexa.interfaces.speaker.AvsSetVolumeItem;
import com.jdsmart.android.alexa.interfaces.speechrecognizer.AvsExpectSpeechItem;
...
import com.jdsmart.android.jvslibrary.global.LogUtils;

import java.util.ArrayList;
import java.util.List;

import static com.jdsmart.android.jvslibrary.global.Constants.PRODUCT_ID;
...
public abstract class BaseActivity extends AppCompatActivity implements BaseListenerFragment.AvsListenerInterface{
    ...
    private AsyncCallback<AvsResponse, Exception> requestCallback = new AsyncCallback<AvsResponse, Exception>() {
        ...
        public void success(AvsResponse result) {
            LogUtils.log("Event Success result ="+result.toString());
        ...
        public void failure(Exception error) {
            ...
            LogUtils.log("Event Error error = "+error.getMessage());
            setState(STATE_FINISHED);
        }

        @Override
        public void complete() {
            LogUtils.log("Event Complete");
    ...
    private void checkQueue() {
        ...
        Log.i("LogUtils","Item type " + current.getClass().getName());
